...
public class InputFormTest {
    ...
    public void test_8() {
        ...
        WebElement dateField = wait.until(ExpectedConditions.visibilityOfElementLocated(inputGroupAddonBy));
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='datepicker-days']//td[text()='" + dayNumberFromDate + "']"))).click();
        String actualResualt = driver.findElement(By.xpath("//div[@id='sandbox-container1']//input")).getAttribute("value");
